...
private Logger logger = Logger.getLogger(AppCheckController.class);
	...
	public ModelAndView check(@RequestParam(value="aid",required=false) String appId,
		...
		md.setViewName("backend/appcheck");
		md.addObject("appVersion", appVersion);
		md.addObject("appInfo", appInfo);
